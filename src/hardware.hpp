...
private:
	...
	volatile uint32_t *_slcr, *_lo_freq, *_rx_divider, *_micro_seq_config, *_micro_seq_memory, *_tx_divider;
	volatile uint32_t *_grad_config, *_grad_mem;
	volatile uint32_t *_grad_update_divider, *_grad_spi_divider, *_grad_serialiser_ctrl,
		*_grad_direct, *_grad_status, *_grad_adc;
